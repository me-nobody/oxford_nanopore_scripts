...
#SBATCH --job-name=bon_bc6#   # some descriptive job name of your choice
...
#SBATCH --time=20:00           # time limit for the whole run, in the form of d-hh:mm:ss, also accepts mm, mm:ss, hh:mm:ss, d-hh, d-hh:mm
############# LOADING MODULES #############
module purge
...
############# END #############
echo "this means  bonito basecaller_6 ran"
