...
#SBATCH --mem=100G
#SBATCH --job-name=bon_bc1          # some descriptive job name of your choice
...
echo $PWD
CuptiUsePerThreadBuffer=false
dir_path="/rds/projects/b/broderra-mrc-alt-telomere/Anu/pilot_data"

model_path="/rds/projects/b/broderra-mrc-alt-telomere/Anu/bonito_models/teloseq_bonito.0.6.2_R941C.fine_tuned" 
...
#        --device cuda:0 --batchsize 256 > $dir_path/EBT_U2OS_15112023/output/EBT_U2OS_T2T_bonito_basecalled.bam  

bonito basecaller $model_path $dir_path/EBT_U2OS_15112023/output_pod5s/ \
       --reference $reference_path/T2Tconsortium_v2.0.fasta \
       --device cuda:0 > $dir_path/EBT_U2OS_15112023/output/EBT_U2OS_T2T_bonito_basecalled.bam      

############# END #############
echo "this means  bonito bc 1 ran"
