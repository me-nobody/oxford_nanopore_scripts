...
#SBATCH --job-name=bonito_basecaller   # some descriptive job name of your choice
...
bonito basecaller $model_path/teloseq_bonito.0.6.2_R941C.fine_tuned $dir_path/EBT_U2OS_15112023/fast5/ \
...
############# END #############
echo "this means  bonito basecaller 2 ran"
