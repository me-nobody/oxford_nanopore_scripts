...
bonito basecaller $model_path/teloseq_bonito.0.6.2_R941C.fine_tuned $dir_path/EBT_U2OS_15112023/output_pod5s/ \
       --reference $reference_path/T2Tconsortium_v2.0.fasta > $dir_path/EBT_U2OS_15112023/output/EBT_U2OS_T2T_bonito_basecalled.bam      

############# END #############
echo "this means  bonito basecaller ran"
