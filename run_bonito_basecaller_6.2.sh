...
#SBATCH --job-name=bnbc6.2          # some descriptive job name of your choice
...
bonito basecaller $model_path/teloseq_bonito.0.6.2_R941C.fine_tuned $dir_path/EBT_U2OS_15112023/output_pod5s/ > $dir_path/EBT_U2OS_15112023/output/EBT__bonito_basecalled_no_aln.bam      

############# END #############
echo "this means  bonito basecaller_6.2 ran"
