...
#SBATCH --job-name=pod5-inspect      # some descriptive job name of your choice
...
echo $PWD
dir_path="/rds/projects/b/broderra-mrc-alt-telomere/Anu/pilot_data/EBT_U2OS_15112023"
pod5 inspect reads PAS21437_8ef8dd30_f245395e_11.pod5
############# END #############
